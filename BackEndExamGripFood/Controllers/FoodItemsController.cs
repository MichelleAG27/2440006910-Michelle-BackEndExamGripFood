...
namespace BackEndExamGripFood.Controllers
{
    ...
    public class FoodItemsController : ControllerBase
    {
        ...
        public async Task<ActionResult<FoodItemDetail>> GetFoodItem(string id)
        {
            if (_context.FoodItems == null)
            {
                return NotFound();
        ...
        public async Task<ActionResult<FoodItem>> Post(FoodItemCreate foodItem)
        {
            if (_context.FoodItems == null)
            {
