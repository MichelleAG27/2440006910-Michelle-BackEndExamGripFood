...
using BackEndExamGripFood.Models;

namespace BackEndExamGripFood.Controllers
{
    ...
    public class RestaurantsController : ControllerBase
    {
        ...
        // GET: api/Restaurants
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Restaurant>>> GetRestaurants(string? search)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Restaurant>> PostRestaurant(RestaurantCreate restaurant)
        {
            if (_context.Restaurants == null)
            {
